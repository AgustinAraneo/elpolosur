    ...
    return (
        <div className='bg-zinc-700 h-screen'>
            <div className='pt-20' data-aos="fade-down" data-aos-delay="500">
                ...
                <h1 className='text-5xl text-cyan-500 text-center mt-3 font-bold'>MAS VENDIDOS</h1>
            </div>
            <div className='flex grid-cols-3 mt-20 gap-x-10 px-4' data-aos="fade" data-aos-delay="700">
                <ProductCard
